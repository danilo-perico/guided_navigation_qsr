...
class Nothing(SoccerField):
    def __init__(self, screen):
        SoccerField.__init__(self, screen)
        self.screen = screen
        self.robofei_logo_scaled = pygame.image.load("RoboFEI_scaled80.png")
    ...
    def draw_nothing(self):
        self.screen.background.fill(self.screen.GREEN)
        square_points = [(0, 0), (0, 1000), (1000, 1000), (1000, 0), (0, 0)]
        pygame.draw.lines(self.screen.background, self.screen.WHITE, False, square_points, 5)
        self.LimitLines = []
        self.LimitLines.append(LimitLine(0, 1000, 0, False))
        self.LimitLines.append(LimitLine(0, 1000, 1000, False))
        self.LimitLines.append(LimitLine(0, 1000, 0))
        self.LimitLines.append(LimitLine(0, 1000, 1000))
